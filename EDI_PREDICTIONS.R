...
knn_model <- knn(train = training_set[, -ncol(training_set)], test = new_data, cl = training_set$Stress.Level, k = 3)
...
cat("K-Nearest Neighbors Prediction:", as.character(knn_model), "\n")
